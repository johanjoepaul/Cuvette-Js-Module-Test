...
const borderColor = {
  ...
  //   focusContainer.style.display = "inline-block";
      // Reset animation by removing the current animation
      focusContainer.style.animation = 'none';
      setTimeout(() => {
        focusContainer.style.display = "inline-block";
    
        // Force reflow to restart the animation
        focusContainer.offsetWidth; // Trigger reflow to apply the animation again
    
        // Apply the animation
        focusContainer.style.animation = '';
      }, 10);
  }
